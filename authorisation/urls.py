...
from .views import UserCreateView,  UserRetrieveView, UserDeleteView, UserListCreateView, UserUpdateView, LoginView
...
urlpatterns = [
    ...
    path('users/login/', LoginView.as_view(), name='users_login'),
]