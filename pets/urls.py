...
from .views import PetRetrieveView, PetCreateView, PetDeleteView, PetUpdateView, PetListCreateView, PetFeedView
...
urlpatterns = [
    ...
    path('pets/<int:pk>/recommendations/', PetFeedView.as_view(), name='pet_recommendations'),
